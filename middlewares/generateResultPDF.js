...
function generateResultPDF(req, res, next) {
  ...
  doc
    .fontSize(9)
    .text(`${result.student.firstName.toUpperCase()} ${result.student.lastName.toUpperCase()}`, 70, 190)
  ...
  doc
    ...
    .stroke()
    .fontSize(11)
    .text(`${result.uploadedBy.firstName} ${result.uploadedBy.lastName}`, 53 + 150, row + 43)
  ...
  doc
    ...
    .stroke()
    .fontSize(14)
    .text('Principal\'s Remark and Signature:', 54, row + 94, { bold: true })
    .fontSize(11)
    .text(result.principalsRemark, 54, row + 115)

  if (result.isApproved) {
    doc
      .font("Helvetica-BoldOblique")
      .fontSize(13)
      .text('AMA', 480, row + 165, { bold: true })
  }
